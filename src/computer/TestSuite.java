...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully()throws InterruptedException{
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"),"Michael");
        sendTextToElement(By.id("BillingNewAddress_LastName"),"Peter");
        sendTextToElement(By.id("BillingNewAddress_Email"),"MichaelPeter100@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"),"ABC Limited");
